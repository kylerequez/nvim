return {
	...
	},
	{
		...
		config = function()
			...
			local lsp_group = vim.api.nvim_create_augroup("kickstart-lsp-attach", { clear = true })
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- Optimized keymaps: Using builtin LSP functions where possible
			...
			require("mason-tool-installer").setup({
				...
				auto_update = false, -- Improve startup time
				run_on_start = false, -- Improve startup time
			})
